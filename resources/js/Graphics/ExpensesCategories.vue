...
async function fetchChart() {
    try {
        ...
        const res = await axios.get("/charts/expense-categories", { params });
        ...
        quantityRevenues.value = res.data.final_expenses ?? 0;
    } catch (err) {
